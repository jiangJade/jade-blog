...
### 2. 如何在ES5环境下实现const
    ...
    (1) 实现const的关键在于Object.defindProperty()[https://developer.mozilla.org]['https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/defineProperty']，
